...
class Exercise11_5 {
    public static void main(String[] args) {
        ...
        list.add(new Student9("홍길동", 1, 1, 100, 100, 100));
        list.add(new Student9("남궁성", 1, 2, 90, 70, 80));
        list.add(new Student9("김자바", 1, 3, 80, 80, 90));
        list.add(new Student9("이자바", 1, 4, 70, 90, 70));
        list.add(new Student9("안자바", 1, 5, 60, 100, 80));
